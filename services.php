            ...
            <div class="col-md-6 col-lg-4 mb-4" data-scroll>
                <div class="card service-card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body service-card-body">
                        ...
                        <a href="courses.php" class="btn btn-primary btn-sm mt-3">Learn More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-scroll>
                <div class="card service-card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body service-card-body">
                        ...
                        <a href="contact.php" class="btn btn-primary btn-sm mt-3">Inquire</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-scroll>
                <div class="card service-card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body service-card-body">
                        ...
                        <a href="contact.php" class="btn btn-primary btn-sm mt-3">Connect</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-scroll>
                <div class="card service-card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body service-card-body">
                        ...
                        <a href="contact.php" class="btn btn-primary btn-sm mt-3">Consult</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-scroll>
                <div class="card service-card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body service-card-body">
                        ...
                        <a href="contact.php" class="btn btn-primary btn-sm mt-3">Support</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4" data-scroll>
                <div class="card service-card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body service-card-body">
                        ...
                        <a href="courses.php" class="btn btn-primary btn-sm mt-3">Explore</a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-light py-5">
    <div class="container">
        <div class="section-header mb-5">
            ...
            <p>We provide comprehensive, professional, and results-oriented solutions</p>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb-4" data-scroll>
                <div class="service-benefit">
                    ...
                    <h5>Expert Team</h5>
                    <p>Our team consists of experienced professionals with proven expertise in their respective fields.</p>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4" data-scroll>
                <div class="service-benefit">
                    ...
                    <p>We focus on delivering measurable results and ensuring client satisfaction with every project.</p>
                </div>
            </div>
...
<section class="cta-section">
    <div class="container">
        ...
        <p>Contact us today to discuss how our services can benefit your team</p>
