...
$pageDescription = 'How ICTECH Solutions Limited uses cookies and similar browser storage.';
require_once __DIR__ . '/includes/header.php';
?>
<main class="container py-5">
    <article class="col-lg-9 mx-auto">
        <h1>Cookie Policy</h1>
        <p>ICTECH Solutions Limited uses essential cookies and browser storage needed to operate this website securely.</p>
        <h2>Essential session cookies</h2>
        <p>When you use sign-in, account, or form features, an essential session cookie keeps your session secure and helps protect against unauthorised requests. This cookie is not used for advertising or cross-site tracking.</p>
